...
function Dashboard() {
  ...
  const [showStindrTriageModal, setShowStindrTriageModal] = useState(false);
  const [showLexaModalKit, setShowLexaModalKit] = useState(false);
  const [showSTDModalKit, setShowSTDModalKit] = useState(false);
  ...
  const callstindrKit = () => {
    setShowStindrTriageModal(true);
  };
  const callLexaKit = () => {
    setShowLexaModalKit(true);
  };
  const callSTDKit = () => {
    setShowSTDModalKit(true);
  };
  const callStindr = () => {
    handleNewTest();
  };
  const callLexa = () => {
    setShowLexaModalKit(false);
    callLexaModel();
  };
  const callSTDSpecialist = () => {
    setShowSTDModalKit(false);
    callSpecialistModel();
  };
  ...
  const handleNewTest = async () => {
    setShowModal(false);
    setShowStindrTriageModal(false);
      ...
      <div className="container-fluid py-4 px-5">
        <div className="row g-4 ">
          ...
          <div className="col-md-3">
            <div
              className="card hover-card d-flex flex-row overflow-hidden position-relative"
              style={{
                height: "250px",
                borderRadius: "12px",
                cursor: "pointer",
              }}
              onClick={callstindrKit}
            >
              <div
                className="w-100 d-flex flex-column justify-content-center align-items-center text-center p-4 text-white"
                style={{
              ...
              >
                ...
                ></div>
                <h4 className="card-title text-light-green" style={{ zIndex: 2 }}>
                  Stindr Triage
                </h4>
                <p className="card-text text-light-green" style={{ zIndex: 2 }}>
                  Check yourself with confidence.
                </p>
                <span className="link-design btn btn-light" style={{ zIndex: 2 }}>
                  Check My Health
                </span>
              </div>
            </div>
          ...
          <div className="col-md-3">
            ...
            >
              ...
              >
                ...
                ></div>
                <h4 className="card-title text-light-blue" style={{ zIndex: 2 }}>
                  Find Me Test Kit
                </h4>
                <p className="card-text text-light-blue" style={{ zIndex: 2 }}>
                  Prioritize the treatment for you.
                </p>
                <span className="link-design btn btn-light" style={{ zIndex: 2 }}>
                  Get My Test
                </span>
          ...
          <div className="col-md-3">
            ...
            >
              ...
              >
                ...
                <p className="card-text text-light-green" style={{ zIndex: 2 }}>
                  Your personalised Stindr assistant
                </p>
                <span className="link-design btn btn-light" style={{ zIndex: 2 }}>
                  Start Chat
                </span>
          ...
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">Lexa</h5>
                <button
                  type="button"
                  className="btn-close dashboard"
                  onClick={() => setShowLexaModalKit(false)}
                ></button>
              </div>
              <div className="modal-body">
                <p>Be confident in your answers to get better results.</p>
              </div>
              <div className="modal-footer">
                
                <button className="btn btn-primary" onClick={callLexa}>
                  Sure
                </button>
              </div>
            </div>
            ...
            <div className="modal-content">
              <div className="modal-header">
                ...
                <button
                  type="button"
                  className="btn-close dashboard"
                  onClick={() => setShowSTDModalKit(false)}
                ></button>
              </div>
              <div className="modal-body">
                <p>Be confident in your answers to get better results.</p>
              ...
              <div className="modal-footer">
                ...
                <button className="btn btn-primary" onClick={callSTDSpecialist}>
                  Get Now
                </button>
              </div>
            </div>
      ...
      {showStindrTriageModal && (
        ...
        >
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">Stindr Triage</h5>
                <button
                  type="button"
                  className="btn-close dashboard"
                  onClick={() => setShowStindrTriageModal(false)}
                ></button>
              </div>
              <div className="modal-body">
                <p>Be confident in your answers to get better results.</p>
              ...
              <div className="modal-footer">
                ...
                <button className="btn btn-primary" onClick={callStindr}>
                  Let Start
                </button>
              </div>
            </div>
